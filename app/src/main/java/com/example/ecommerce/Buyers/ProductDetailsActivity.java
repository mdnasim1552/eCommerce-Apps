...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numberButton.setOnValueChangeListener(new ElegantNumberButton.OnValueChangeListener() {
            ...
            public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                String newNumber = formatter.format(x*newValue);
                productPrice.setText(newNumber+" Tk");
            }
        });
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    productPrice.setText(formatter.format(Integer.valueOf(products.getPrice()))+" Tk");
                    x=Integer.valueOf(products.getPrice());
    ...
    private void addingToCartList()
    {
        ...
        cartMap.put("price", String.valueOf(x));
